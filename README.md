...
This ZIP is also Render-ready. See `CLOUD_DEPLOYMENT.md` for the complete cloud deployment steps. The included `render.yaml` configures Gunicorn, HTTPS-ready public hosting, `/health`, and a persistent `/var/data` disk for the SQLite databases and uploads.
